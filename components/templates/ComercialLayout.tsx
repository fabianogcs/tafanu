    ...
    >
      ...
      {(hasWhatsapp || hasPhone) && (
        <motion.button
          ...
          className={`fixed bottom-20 right-6 md:bottom-10 md:right-10 z-50 w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:scale-105 active:scale-95 transition-all ${
            hasWhatsapp
