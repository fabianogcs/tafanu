...
const SINONIMOS_BASE: Record<string, string[]> = {
  // --- SAÚDE E BEM-ESTAR ---
  dente: ["dentista", "odontologia", "clinica odontologica", "aparelho", "clareamento", "implante"],
  olho: ["oculos", "otica", "lente", "exame de vista", "lentes de contato", "armacao", "oftalmologista", "oculista"],
  medico: ["clinica medica", "consulta", "exame", "laboratorio", "pediatra", "ginecologista", "cardiologista"],
  mente: ["psicologo", "psicologia", "terapia", "psiquiatra", "terapeuta"],
  corpo: ["massagem", "drenagem", "clinica de estetica", "spa", "emagrecimento", "fisioterapia", "quiropraxia"],

  // --- ALIMENTAÇÃO E BEBIDA ---
  pao: ["padaria", "panificadora", "confeitaria", "paes", "baguete"],
  lanche: ["hamburguer", "hamburgueria", "sanduiche", "fast food", "hot dog", "cachorro quente"],
  pizza: ["pizzaria", "calzone", "rodizio"],
  marmita: ["quentinha", "pf", "prato feito", "restaurante", "comida caseira", "marmitex"],
  ...
  vazamento: ["cano", "encanador", "hidraulico", "desentupidora", "bombeiro hidraulico"],
  ...
  costura: ["costureira", "conserto de roupa", "bainha", "alfaiate", "sapateiro"],
  grafica: ["impressao", "copiadora", "xerox", "banner", "cartao de visita", "adesivo"],

  // --- AUTOMOTIVO ---
  carro: ["mecanica", "mecanico", "oficina", "automotivo", "auto pecas", "veiculo", "carros"],
  ...
  lavagem: ["lavar", "lava jato", "estetica automotiva", "polimento", "lavar car", "lava rapido"],
  ...
  cabelo: ["salao", "cabeleireiro", "barbearia", "corte", "mechas", "coloracao", "cabelereiro"],
  pelo: ["depilacao", "cera", "laser", "pelos"],
  rosto: ["sobrancelha", "cilios", "maquiagem", "limpeza de pele", "estetica", "harmonizacao facial"],
  roupa: ["vestuario", "loja", "moda", "boutique", "calcados", "sapato", "vestido", "camisa", "roupas"],

  // --- TECNOLOGIA E VAREJO ---
  celular: ["smartphone", "capinha", "assistencia", "eletronicos", "conserto", "iphone", "celulares"],
  informatica: ["computador", "notebook", "pc", "ti", "manutencao de pc", "tecnico", "formatacao"],
  presente: ["lembrancinha", "floricultura", "papelaria", "variedades", "brinquedo"],
  mercado: ["supermercado", "mercearia", "hortifruti", "sacolao", "atacadao"],
  remedio: ["farmacia", "drogaria", "medicamento"],

  // --- EVENTOS E LAZER ---
  academia: ["musculacao", "crossfit", "pilates", "personal", "fitness", "treino", "luta", "natacao"],
  festa: ["eventos", "buffet", "decoracao de festas", "espaco para festas", "aniversario", "casamento", "festas"],
  foto: ["fotografo", "ensaio", "book", "estudio fotografico", "filmagem"],

  // --- IMÓVEIS E LOGÍSTICA ---
  casa: ["imobiliaria", "aluguel", "venda", "apartamento", "corretor", "terreno", "imovel"],
  construcao: ["material de construcao", "cimento", "tijolo", "ferragem", "deposito", "tintas"],
  frete: ["mudanca", "carreto", "transporte", "logistica", "caminhao"],

  // --- EDUCAÇÃO E BUROCRACIA ---
  escola: ["colegio", "creche", "bercario", "reforco escolar", "curso", "idiomas", "ingles", "autoescola"],
  justica: ["processo", "advogado", "advocacia", "juridico", "cartorio"],
  imposto: ["cnpj", "contador", "contabilidade"],

  // --- PETS ---
  pet: ["animal", "cachorro", "gato", "pet shop", "veterinario", "clinica veterinaria", "animais"],
